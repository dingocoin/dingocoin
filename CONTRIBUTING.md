# Contributing to Dingocoin Core

Dingocoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/dingocoin/dingocoin/labels/help%20wanted)
* [Projects](https://github.com/dingocoin/dingocoin/projects)
* [Dingocoindev on reddit](https://www.reddit.com/r/dingocoindev/)

## Branch Strategy

Dingocoin Core's default branch is intentionally a stable release, so that anyone
...
Dingocoin Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Dingocoin Core
releases will automatically benefit from these.

When refactoring Dingocoin-specific code, please keep refactoring requests short,
...
The following applies to code changes to Dingocoin Core, and is not to be
confused with overall Dingocoin Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Dingocoin Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Dingocoin; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Dingocoin
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Dingocoin consensus, it must have been
