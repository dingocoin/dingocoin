...
class BumpFeeTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 25 outputs of 10 DINGO
        print("Mining blocks...")
        ...
        test_dingocoin_wallet_minchange(rbf_node, dest_address)
...
def test_settxfee(rbf_node, dest_address):
    # Dingocoin: Increment is fixed, so this test tests for settxfee not making a difference
...
def test_dingocoin_wallet_minchange(rbf_node, dest_address):
    ...
    # bump the fee with the default incremental fee; this should add 0.001 DINGO
    bumped_tx = rbf_node.bumpfee(rbfid)
