...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # a Dingocoin Core node that behaves similar to mainnet policies
    ...
    def run_test(self):
        ...
        ### test constants ###
        koinu = Decimal("0.00000001")          # 1 Koinu expressed in DINGO
        ten = Decimal("10.0")                  # uniform 10 DINGO seed moneys
        ...
        # create a bunch of UTXO with seed money from the Dingocoin Core wallet
        for i in range(20):
        ...
        # test legacy output of 1 DINGO output and 1 DINGO fee
    ...
    # spend seed money with a key not in the Dingocoin Core wallet.
    def spend_utxo(self, output, expected_size, retries=0):
        # construct the transaction using Dingocoin Core raw tx APIs
        ...
        # and send the tx from there rather than from Dingocoin Core, to test
