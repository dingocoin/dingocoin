...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/dingocoin.ico %{buildroot}%{_datadir}/pixmaps/dingocoin.ico
install -p share/pixmaps/nsis-header.bmp %{buildroot}%{_datadir}/pixmaps/
install -p share/pixmaps/nsis-wizard.bmp %{buildroot}%{_datadir}/pixmaps/
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/bitcoin.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/dingocoin16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/dingocoin32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/dingocoin64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/dingocoin128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/dingocoin256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/dingocoin256.png %{buildroot}%{_datadir}/pixmaps/dingocoin16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/dingocoin256.png %{buildroot}%{_datadir}/pixmaps/dingocoin32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/dingocoin256.png %{buildroot}%{_datadir}/pixmaps/dingocoin64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/dingocoin256.png %{buildroot}%{_datadir}/pixmaps/dingocoin128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/dingocoin256.png %{buildroot}%{_datadir}/pixmaps/dingocoin256.xpm
