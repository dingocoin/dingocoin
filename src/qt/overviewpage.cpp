...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Dingocoin Core repository on GitHub"),
        tr("Services that claim to double your dingocoins are always ponzi schemes")
    };
