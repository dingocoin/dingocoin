 ...
 * Dingocoin miners have a hightened incentive to not orphan blocks while the
...
static const double MAX_FEERATE = COIN * 10.0;    //!< 1000,000,000 koinu - equals 10 DINGO/kb
