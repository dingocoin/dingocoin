...
API JSON-RPC được cung cấp bởi Dingocoin Core là self-documenting và có thể đọc lướt qua với `dingocoin-cli help`, trong khi thông tin chi tiết cho từng lệnh có thể được xem với `dingocoin-cli help <command>`.
