Dingocoin Core version 1.14.8 is now available from:

  <https://github.com/dingocoin/dingocoin/releases/tag/v1.14.8/>

This is a new minor version release. Dingocoin users on any platform are
...
Several important updates have been added to Dingocoin Core, including fixes
backported from Bitcoin Core's upstream.

### Reduce Peer INV Object Counts

Previously, Dingocoin Core nodes would maintain a large list of inventory for
...
A new transaction request tracking system improves the way Dingocoin Core
...
In previous versions of Dingocoin Core, orphan transactions were processed in a
...
Dingocoin Core now sends a getheaders message for one block when announced in an
...
vulnerability or security issue in Dingocoin Core.
...
* Dingocoin Core now supports compilation with C++14 and C++17, if you select
